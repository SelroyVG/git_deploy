Входные параметры:
  ...
  Необязательные: 
  "--sliza" -- если параметр указан, после того как репозиторий будет развёрнут, пользователю будет предложено настроить файл конфигурации.
...
CSV-файл должен быть составлен по следующим правилам:
  ...
  <Значение_шаблон>,<Подставляемое_значение>